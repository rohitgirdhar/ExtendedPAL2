...
GLOG_logtostderr=1 ${CODE_PATH}/computeFeatures.bin \
    ...
    -l fc7 \
    -o /home/rgirdhar/data/Work/Datasets/processed/0010_ExtendedPAL_moreTest/features/CNN/fc7_test \
    -w /home/rgirdhar/data/Work/Datasets/processed/0010_ExtendedPAL_moreTest/features/selsearch_boxes \
    -t hdf5 \
    --ids2compute4 /srv2/rgirdhar/Work/Datasets/processed/0010_ExtendedPAL_moreTest/lists/NdxesPeopleTest.txt
