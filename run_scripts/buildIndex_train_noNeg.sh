...
nice -n 10 $CODE_PATH/buildIndex.bin \
    ...
    --ids2compute4 /srv2/rgirdhar/Work/Datasets/processed/0010_ExtendedPAL_moreTest/lists/NdxesTrain_noNeg.txt \
    -c /srv2/rgirdhar/Work/Datasets/processed/0010_ExtendedPAL_moreTest/features/selsearch_boxes/counts.txt \
    -s /srv2/rgirdhar/Work/Datasets/processed/0010_ExtendedPAL_moreTest/search/indexes/train_noNeg.index \
    -b 256 \
    -t 1 \
    -a 900 \
    --nTrain 500000
