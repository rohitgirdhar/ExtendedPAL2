...
$CODE_PATH/main.bin \
    ...
    -o /srv2/rgirdhar/Work/Datasets/processed/0010_ExtendedPAL_moreTest/matches/CNN/train/ \
    -m /srv2/rgirdhar/Work/Datasets/processed/0010_ExtendedPAL_moreTest/lists/NdxesPeopleTrain.txt \
